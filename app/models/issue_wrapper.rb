  ...
  def to_hash
    {
      ...
      :assignee => ::AuthorWrapper.new(@issue.assigned_to).to_hash,
      :watchers => @issue.watcher_users.collect{|u| ::AuthorWrapper.new(u).to_hash},
      :custom_fields => @issue.custom_field_values.collect{|u| ::CustomFieldWrapper.new(u).to_hash}
    }
  end
end
